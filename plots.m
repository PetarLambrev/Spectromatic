function h = plots(Dat,Options)
% PLOTS - Plot spectra in new figure
%
% Synthax
%   plots(Dat,TitleText,LegendText)
%   plots(...,Name,Value)
%   h = plots(...)
% 
% Description
%   plots(Dat) creates a new figure and plots Dat
%   plots(...,Name,Value) allows for various formatting parameters
%   h = plots(...) returns handle to the created figure
%
%  Note: plots is primarily used in splitop and splitapply to create 
%     multiple figures
%
...
% Run figureStart
if isempty(Options.StartFun) && exist("figureStart.m","file")==2
    figureStart;
end
...
plot(Dat,"LegendText",Options.LegendText,...
